...
% ==========================================
% SLIDE 10: SCALING CONSIDERATIONS (Renumbered)
% ==========================================
...
% ==========================================
% SLIDE 11: Bundle Nodalization (NOW SECOND)
% ==========================================
...
% ==========================================
% SLIDE 13: Discretization Comparison
% ==========================================
...
% ==========================================
% SLIDE 15: MASS CONSERVATION (Resized for Badge Visibility)
% ==========================================
...
% ==========================================
% SLIDE 18: Governing Equations (Mixture)
% ==========================================
...
% ==========================================
% SLIDE 20: Mixing (With Explanation)
% ==========================================
...
% ==========================================
% SLIDE 21: UNCERTAINTY (With Explanation)
% ==========================================
\begin{frame}[t]{The Uncertainty Challenge}
    \begin{columns}[T,onlytextwidth]
        ...
        \begin{tikzpicture}
            \node[fill=HadronLight, rounded corners=3pt, inner sep=5pt, text width=0.9\linewidth, font=\tiny] {
                \textbf{Plot Meaning:} The solid blue line is the "Perfect" distribution. The dashed red line is the "Real World" distribution. Variances widen the bell curve, pushing the "tail" closer to the failure point (Limit), eating up margin.
            };
        \end{tikzpicture}
...
\begin{frame}[t]{Statistical Methodology: RTDP vs. Monte Carlo}
    \begin{columns}[T,onlytextwidth]
        ...
        \begin{block}{Monte Carlo Sampling}
            \begin{itemize}
                \item Run subchannel code 1000s of times.
        ...
        \end{tikzpicture}
        \vspace{1em}
        \textbf{Target: 95/95 Confidence/Probability}
    \end{columns}
\end{frame}
...
\begin{frame}[t]{Operational Response Workflow}
    ...
    \begin{tikzpicture}[node distance=1.5cm, auto, thick]
        ...
        \node[below=0.2cm of step2, align=left, font=\tiny] {Run 3-Field Code\\Check Min Film Mass};
        \node[below=0.2cm of step3, align=left, font=\tiny] {Margin < Limit?\\Adjust Flow/Power};
    \end{tikzpicture}
